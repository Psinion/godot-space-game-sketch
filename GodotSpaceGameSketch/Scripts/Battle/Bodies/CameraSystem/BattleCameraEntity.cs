...
namespace GodotSpaceGameSketch.Battle.Bodies.CameraSystem;

public partial class BattleCameraEntity : Node3D
{
	private CelestialBodyView target;
	private Vector3 targetVelocity;
	private float targetSmoothTime = 0.10f;
	...
	public void SetTarget(Battle.Bodies.CelestialBodyView bodyView)
	{
		target = bodyView;
	}
}